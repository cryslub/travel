...
export default async function JourneysLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 flex items-center justify-between border-b border-zinc-200 bg-white px-6 py-3 dark:border-zinc-700 dark:bg-zinc-900">
